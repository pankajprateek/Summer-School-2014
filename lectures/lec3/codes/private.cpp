...
class Pri: private Base {
  ...
  Pri() {
    // The derived class always uses the 
    // immediate parent's class access specifications
...
int main() {
  ...
  Pri cPri;
  cPri.m_nPublic = 1; 
  // not okay: m_nPublic is now a private 
  // member when accessed through Pri
  cPri.m_nPrivate = 2; 
  // not okay: can not access 
  // private members from outside class
  cPri.m_nProtected = 3; 
  // not okay: m_nProtected is now a 
  // private member when accessed through Pri
