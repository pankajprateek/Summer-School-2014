...
public:
  Pub() {
    // The derived class always uses the immediate 
    // parent's class access specifications
...
int main() {
  // Outside access uses the access 
  // specifiers of the class being accessed.
  // In this case, the access specifiers of cPub.  
  // Because Pub has inherited publicly from Base,
